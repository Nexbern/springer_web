...
import { stemPrograms, schoolInfo } from '@/data/siteData';
import { AnimatedCard } from '@/components/ui-custom/AnimatedCard';
import { SectionHeader } from '@/components/ui-custom/SectionHeader';
import Link from 'next/link';

export const metadata: Metadata = {
    title: 'STEM & Skill Development',
                            ...
                            return (
                                <AnimatedCard key={program.id} delay={index * 100}>
                                    <div className="group card-modern p-8 h-full">
                                        <div
                                            className={`w-16 h-16 rounded-2xl flex items-center justify-center mb-6 transition-all duration-300 group-hover:scale-110 ${isRed
