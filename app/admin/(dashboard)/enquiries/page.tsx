    ...
    return (
        <div className="max-w-7xl mx-auto">
            ...
            <Tabs defaultValue="campus" className="w-full">
                <TabsList className="grid grid-cols-2 lg:grid-cols-4 gap-2 mb-6 w-full">
                ...
                <TabsContent value="campus">
                    {campusVisits.length === 0 ? (
                        <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-12 text-center text-springer-gray">
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-3">
                                            <div className="flex items-center gap-2">
                                                <User className="w-4 h-4 text-springer-red flex-shrink-0" />
                                                <div>
                                        ...
                                        <div className="space-y-2 text-xs">
                                            <div className="flex items-center gap-1 text-springer-gray">
                                                <MapPin className="w-3 h-3" />
                                                <span className="line-clamp-1">{visit.address}</span>
                                            </div>
                                            <div className="flex items-center gap-1 text-springer-charcoal">
                                                <Calendar className="w-3 h-3 text-springer-red" />
                                                {format(new Date(visit.preferredDate), 'MMM dd, yyyy')} • {timeSlotLabels[visit.preferredTimeSlot]}
                                            </div>
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-springer-gray">
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-3">
                                            <div>
                                                ...
                                                <div className="text-xs text-springer-gray mt-1">
                                        ...
                                        <div className="space-y-2 text-xs">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <span className="text-springer-gray">
                                                    {format(new Date(enquiry.createdAt), 'MMM dd')}
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    >
                                        <div className="flex items-start justify-between mb-3">
                                            <div>
                                                ...
                                                <div className="text-xs text-springer-gray mt-1 flex items-center gap-1">
                                        ...
                                        <div className="space-y-2 text-xs">
                                            ...
                                            <div className="text-springer-gray line-clamp-2">
                                                {enquiry.message}
                                            </div>
                                            <div className="text-springer-gray text-right">
                                                {format(new Date(enquiry.createdAt), 'MMM dd')}
                                            </div>
                                        </div>
                                    </div>
