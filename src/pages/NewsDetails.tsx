        ...
        return (
            <div className="min-h-screen flex items-center justify-center">
                <div className="text-center">
                    ...
                    <Link to="/notices" className="text-springer-red hover:underline">
                        Back to Notices
                    </Link>
                </div>
            </div>
        ...
        <main className="min-h-screen bg-springer-white pt-36 pb-20">
            <div className="section-padding max-w-4xl mx-auto">
                ...
                <motion.div
                    ...
                    className="flex items-center gap-2 text-sm text-springer-gray mb-6"
                >
                    <Link to="/" className="hover:text-springer-red transition-colors">
                        <Home className="w-4 h-4" />
                    </Link>
                    <span>/</span>
                    <Link to="/notices" className="hover:text-springer-red transition-colors">
                        Notices
                    </Link>
                    <span>/</span>
